...
APP_NAME=userprofileandconnectionsimpl
DAEMON=bin/$APP_NAME
function stopServer() {
...
function startServer() {
        ...
        nohup $DAEMON >$TMP_LOG  -Dlagom.cluster.join-self=on -Dconfig.file=/opt/livelygig/user_profile_connection_prod.conf 2>&1 &
