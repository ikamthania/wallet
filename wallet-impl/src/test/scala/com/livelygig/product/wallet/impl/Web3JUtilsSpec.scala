...
class Web3JUtilsSpec extends WordSpec with Matchers with BeforeAndAfterAll with OptionValues {
  ...
  "The ethereum utils" should {
    ...
    "sendEtherTransaction" should {
      "give a transaction hash" in {
        val trasactionHash =
          web3jUtils
            .sendTransaction("0xb4817e61db822c6331c9ea25fffdb963b997c3ff",
              EtherTransaction("123456789","0xb4817e61db822c6331c9ea25fffdb963b997c3ff","1","eth",18), "UTC--2017-08-28T06-57-38.574000000Z--b4817e61db822c6331c9ea25fffdb963b997c3ff.json")
        println(trasactionHash)
      }
    }
    ...
    "validate" should {
      "validate the file" in {
        web3jUtils
          .obtainCredentials(ValidateWalletFile(keystore,"123456789")) shouldBe an[Credentials]
      }
    }
