...
case class RootModel(user: UserRootModel, ERCToken: Pot[ERCTokenRootModel], transaction: Pot[TransactionRootModel], i18n: I18NRootModel, currencies: MarketPricesRootModel)
