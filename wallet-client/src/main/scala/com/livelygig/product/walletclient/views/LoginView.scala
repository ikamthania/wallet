          ...
          <.div(
            ...
            <.div(
              ...
              <.h4(
                ...
                """@Messages("log.in.credentials")"""))),
          """@helper.form(action = controllers.api.v1.wallet.auth.routes.WalletAuthController.walletLogin(),Symbol("data-toggle")-> "validator") {
    @helper.CSRF.formField@helper.CSRF.formField""",
          <.div(
        ...
        @request.flash.get("success").map { msg =>""",
          ...
          <.div(
            ...
            """@b3.checkbox(walletSignInForm("rememberMe"),'_text -> Messages("remember.me"), 'checked -> true)"""),
          <.div(
            ...
            <.div(
              ...
              <.div(
                ...
                <.span("""@Messages("not.a.member")"""),
                <.a(
                  ^.href := "@routes.ViewController.walletSignup",
                  """@Messages("sign.up.now")""")),
              <.button(
